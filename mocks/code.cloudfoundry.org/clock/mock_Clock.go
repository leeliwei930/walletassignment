...
func (_m *MockClock) NewTicker(d time.Duration) clock.Ticker {
	ret := _m.Called(d)
...
// MockClock_NewTicker_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NewTicker'
type MockClock_NewTicker_Call struct {
	*mock.Call
}

// NewTicker is a helper method to define mock.On call
//   - d time.Duration
func (_e *MockClock_Expecter) NewTicker(d interface{}) *MockClock_NewTicker_Call {
	return &MockClock_NewTicker_Call{Call: _e.mock.On("NewTicker", d)}
}

func (_c *MockClock_NewTicker_Call) Run(run func(d time.Duration)) *MockClock_NewTicker_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(time.Duration))
	})
	return _c
...
func (_c *MockClock_NewTicker_Call) Return(_a0 clock.Ticker) *MockClock_NewTicker_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClock_NewTicker_Call) RunAndReturn(run func(time.Duration) clock.Ticker) *MockClock_NewTicker_Call {
	_c.Call.Return(run)
	return _c
}

// NewTimer provides a mock function with given fields: d
func (_m *MockClock) NewTimer(d time.Duration) clock.Timer {
	ret := _m.Called(d)
...
//   - d time.Duration
func (_e *MockClock_Expecter) NewTimer(d interface{}) *MockClock_NewTimer_Call {
...
func (_c *MockClock_NewTimer_Call) Return(_a0 clock.Timer) *MockClock_NewTimer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClock_NewTimer_Call) RunAndReturn(run func(time.Duration) clock.Timer) *MockClock_NewTimer_Call {
	_c.Call.Return(run)
	return _c
}
